...
public class GestionMaterielServiceImpl implements GestionMaterielService {
    ...
    public void supprimerMateriel(int id) {
        ...
        System.out.println("Materiel supprim̩ avec succ̩s");
    }
        ...
        if (materiel.isAvailable()) {
            if (materiel.getQuantity() > 0){
                if (quantity <= materiel.getQuantity()){
                    ...
                    System.out.println("Vous avez allou̩ " + quantity + " " + materiel.getName() + "(s) avec succ̬s");
                }
                else
                    System.out.println("La quantit̩ disponible est : " + materiel.getQuantity());
            } else {
    ...
    public void rendreMateriel(int id, int userID, int quantity) {
        ...
        if (materielAllocated != null) {
            if (quantity <= materielAllocated.getQuantity()) {
                ...
                System.out.println("La quantit̩ allou̩ est : " + materielAllocated.getQuantity());
        }
        else {
            System.out.println("Ce materiel n'est pas allou̩");
        }
    }
