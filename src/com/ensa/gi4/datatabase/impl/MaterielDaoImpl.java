...
public class MaterielDaoImpl extends GenericDAO<Materiel> implements MaterielDao {
    ...
    public void ajouterUnMateriel(Materiel materiel) {
        super.makeQuery("INSERT INTO MATERIEL (NAME, CODE, TYPE) VALUES ('"+materiel.getName()+"', '"+materiel.getCode()+"','"+materiel.getType()+"' );");

    }

    @Override
    public void supprimer(int id) {
        super.makeQuery("DELETE FROM MATERIEL WHERE ID = "+id);
    }

    @Override
    public void modifier(int id, String code, String name) {
        super.makeQuery("UPDATE MATERIEL SET NAME = '"+name+"' ,CODE = '"+code+"' WHERE ID="+id);
    }

    @Override
    public void indisponible(int id) {
        super.makeQuery("UPDATE MATERIEL SET disponible = FALSE   WHERE ID="+id);
    }

    @Override
    public void allouer(int id, String duree, int  id_user, String username) {
        super.makeQuery("UPDATE MATERIEL SET DUREE = '"+duree+"', ALLOUE = TRUE,  user_id = '"+id_user+"', username = '"+username+"' WHERE ID="+id);
    }

    @Override
    public void render(int id) {
        super.makeQuery("UPDATE MATERIEL SET ALLOUE = FALSE  , USER_ID = NULL, DUREE = NULL, USERNAME = NULL WHERE ID="+id);
    }
