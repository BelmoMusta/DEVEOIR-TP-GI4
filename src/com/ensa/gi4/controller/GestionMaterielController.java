...
public class GestionMaterielController {
    ...
    public void authentification() {
        ...
        while(role == null) {
            ...
            System.out.println("Nom d'utilisateur ou mot de passe est incorrect");
            ...
            if (choix == 0) sortirDeLApplication();
            else if (choix != 1) System.out.println("Le choix est invalide");
            }
        }
        ...
        if (role.equals("administrateur , employée")) {
            while(choix != 1 && choix != 2) {
                System.out.println("Voulez-vous se connecter en tant que administrateur (Taper 1)  : ");
                System.out.println("Voulez-vous se connecter en tant que employée (Taper 2) : ");
