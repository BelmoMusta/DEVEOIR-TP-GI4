...
public class GestionMaterielController {
    ...
    public void afficherMenu(String role, int userID) {
        ...
        if (role.equals("employée")){
            ...
            System.out.println("3- pour chercher un materiel    ");
            System.out.println("4- pour allouer un materiel     ");
            System.out.println("5- pour rendre un materiel      ");
            System.out.println("0- pour sortir de l'application ");
            System.out.println("******************************************\n");
            ...
            System.out.println("1  - pour lister les materiels     ");
            System.out.println("2  - pour lister les allocations   ");
            System.out.println("3  - pour lister mes allocations   ");
            ...
            System.out.println("8  - pour allouer un materiel      ");
            System.out.println("9  - pour rendre un materiel       ");
            System.out.println("10 - pour changer la disponibilité ");
            System.out.println("0  - pour sortir de l'application  ");
            System.out.println("******************************************\n");
            System.out.print("option : ");
            Scanner scanner = new Scanner(System.in);
